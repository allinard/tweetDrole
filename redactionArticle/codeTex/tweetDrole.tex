...
\centering
	...
	\midrule
	DecisionStumps & 0 & 0 & 0 \\%0.7 confiance sans stem
	J48 & 10\% & 10\% & 11.5\% \\ %0.7
	NaiveBayes & 11.5\% & 12.3\% & 12.5\% \\ %0.7
	RandomForest & 10.4\% & 10.6\% & 25\%\\ %0.7

	\midrule
	DecisionStumps & 0 & 0 & 0 \\%0.7 confiance AVEC stem
	J48 & 7.6\% & 7.6\% & 8.2\% \\ %0.7
	NaiveBayes & 10.7\% & 11.1\% & 11.1\% \\ %0.7
	RandomForest & 7.14\% & 7.4\% & 0 \\ %0.7

	\midrule
	DecisionStumps & 0 & 0 & 0 \\%0.7 confiance AVEC stem déséquilibré
	J48 & 0 & 0 & 0 \\ %0.7
	NaiveBayes & 0 & 0 & 0 \\ %0.7
	RandomForest & 100\%  & 100\% & 100\% \\ %0.7
	\bottomrule
	\end{tabular}
